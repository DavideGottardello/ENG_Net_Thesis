...
def EEGNetNoConv2D(nb_classes, Chans = 16, Samples = 1000, 
             dropoutRate = 0.5, kernLength = 100, F1 = 16, 
             D = 2, F2 = 32, norm_rate = 0.25, dropoutType = 'Dropout'):  
...
def EEGNetNoDepthConv2D(nb_classes, Chans = 16, Samples = 1000, 
             dropoutRate = 0.5, kernLength = 100, F1 = 16, 
             D = 2, F2 = 32, norm_rate = 0.25, dropoutType = 'Dropout'):  
...
def EEGNetK150(nb_classes, Chans = 16, Samples = 1000, 
             dropoutRate = 0.5, kernLength = 150, F1 = 16, 
             D = 2, F2 = 32, norm_rate = 0.25, dropoutType = 'Dropout'):  
...
def EEGNetK50(nb_classes, Chans = 16, Samples = 1000, 
...
def EEGNet4x(nb_classes, Chans = 16, Samples = 1000, 
             dropoutRate = 0.5, kernLength = 100, F1 = 16, 
             D = 2, F2 = 32, norm_rate = 0.25, dropoutType = 'Dropout'):  
    ...
    input0  = Input(shape = (Chans, Samples,1))
    input1   = Reshape((Chans // 4, Samples, 4))(input0)
    ...
    block1       = DepthwiseConv2D((Chans // 4, 1), use_bias = False, 
                                   depth_multiplier = D,
                                   depthwise_constraint = max_norm(1.))(block1)
    ...
    return Model(inputs=input0, outputs=softmax)
